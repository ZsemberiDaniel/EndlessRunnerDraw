...
public static class Templates {
    ...
    /// </summary>
    public static void Learn(string name, params Vector2[] points) {
    ...
    public static Template GetBestMatch(List<Vector2> points, float boundingBoxSizeUsed = 1f) {
        int _bestAt = 0;
        float _bestScore = float.MaxValue;

        for (int i = 0; i < templates.Count; i++) {
            float _currScore = PathDistanceAtBestAngle(points, templates[i]);
    ...
    /// </summary>
    private static float PathDistanceAtBestAngle(List<Vector2> points, Template template, float minDeg = -45, 
    ...
    private static float PathDistanceAtAngle(List<Vector2> shape, Template template, float rad) {
    ...
    /// Points is compared to a template to find the average distance between corresponding points
    /// </summary>
    private static float PathDistance(List<Vector2> shape, Template template) {
